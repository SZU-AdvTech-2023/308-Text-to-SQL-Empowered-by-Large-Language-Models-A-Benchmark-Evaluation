...
def get_repr_cls(repr_type: str):
    if repr_type == REPR_TYPE.SQL:
        ...
        repr_cls = CBRPrompt
    elif repr_type == REPR_TYPE.OPENSQL:
        repr_cls = OpenSQLPrompt
    elif repr_type == REPR_TYPE.OPENSQL_SPIDER:
        repr_cls = OpenSQLPrompt_SPIDER
    else:
...
def get_example_selector(selector_type: str):
    ...
    elif selector_type == SELECTOR_TYPE.EUC_DISTANCE_PRE_SKELETON_MASK_SIMILARITY_THRESHOLD:
        selector_cls = EuclideanDistancePreSkeletonQuestionMaskSimilarThresholdSelector
    ...
    elif selector_type == SELECTOR_TYPE.EUC_DISTANCE_PRE_SKELETON_MASK_SIMILARITY_THRESHOLD_SHIFT:
         selector_cls = EuclideanDistancePreSkeletonQuestionMaskSimilarThresholdShiftSelector
    else:
