...
if __name__ == '__main__':
    ...
    parser.add_argument("--data_type", type=str, choices=["kaggle-dbqa", "spider", "realistic","bird"], default="spider")
    ...
    parser.add_argument("--selector_type", type=str, choices=[SELECTOR_TYPE.COS_SIMILAR,
                                                              ...
                                                              SELECTOR_TYPE.EUC_DISTANCE_PRE_SKELETON_MASK_SIMILARITY_THRESHOLD,
                                                              SELECTOR_TYPE.EUC_DISTANCE_MASK_PRE_SKELETON_SIMILARITY_THRESHOLD_SHIFT,
                                                              SELECTOR_TYPE.EUC_DISTANCE_PRE_SKELETON_MASK_SIMILARITY_THRESHOLD_SHIFT
                                                              ], default=None)
    ...
    input_path = os.path.join(path_generate, "input.jsonl")
